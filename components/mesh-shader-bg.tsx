...
export function MeshShaderBg() {
  ...
  useEffect(() => {
    ...
    // Colours: #101010, #F5F5F5, #B0B0B0, #3A3A3A + 4 unused (repeat last)
    ...
    gl.uniform4f(uSurface,  2.40, 1.16, 0.00, 1.00)
    gl.uniform4f(uFinish,   0.00, 0.00, 0.00, 0.09)
    gl.uniform4f(uTransform,1453.0, 0.00, 0.00, 0.0)
    gl.uniform4f(uSpace,    0.00, 0.00, 0.00, 0.00)
    gl.uniform4f(uCursor,   0.00, 2.0,  0.65, 0.46)
    ...
    function onVisibility() {
      ...
      if (!hidden) { rafId = requestAnimationFrame(frame) }
    }

...
const features = [
  ...
  },
  {
    ...
    desc: 'Fijate si lo que te piden está en línea con el mercado de la zona que elegís.',
    href: '#precios',
  },
  {
    icon: LineChart,
      ...
      <div className="mx-auto max-w-6xl px-4 py-16 md:py-24">
        <div className="max-w-2xl">
          <span className="inline-flex items-center rounded-full border border-primary/30 bg-primary/10 px-3 py-1 text-xs font-semibold text-primary">
            Alquilar en Argentina, con datos
          </span>
          ...
          <p className="mt-4 text-pretty text-lg leading-relaxed text-muted-foreground">
            RentIA centraliza todo lo que necesitás antes de firmar: entendé el contrato, conocé los
            valores reales del mercado y anticipá cuánto va a subir tu alquiler.
          </p>
        </div>
